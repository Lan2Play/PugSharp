...
start-ds:
	...
	docker run --rm -it --net=host -v /home/volza/temp/cs2/cs2-data/cs2-data:/home/steam/cs2-dedicated/ --name=cs2-dedicated -e STEAMUSER=cs2_lan2play -e STEAMPASS=vZ23qYxdyFLKZyI1rnbrFHEmGfET lan2play/cs2
